...
public final class EmailConfirmationMessageHandler implements MessageHandler {
    private final String EMAIL_SUBJECT = "Email confirmation for example.io service.";
    private final Properties emailProperties;
    private final String email;
    private final String emailPassword;
    private final Integer emailExpireSeconds;

    public EmailConfirmationMessageHandler(String emailPropertiesFile, String email,
        ...
        this.email = email;//"exampleapp@yahoo.com";
        this.emailPassword = emailPassword;
        this.emailExpireSeconds = emailExpireSeconds;//3600
    }
    ...
    public void handleMsg(String message) throws IOException {
        try {
            ...
            storeValueAssociatedWithKey(RedisKeysPrefixes.EMAIL_TOKEN + username, uuid);
    ...
    private void sendEmail(String email, String content) throws MessagingException {
        Session session = Session.getInstance(emailProperties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(EmailConfirmationMessageHandler.this.email, emailPassword);
            }
        });
    ...
    private String createEmailContent(String username, String uuid){
        return  "<h3>Hello " + username + ". </h3>" +
                ...
                + username + "/confirmation/" + uuid + "\">link</a> " +
